...
public class GildedRoseTest {
    ...
    @Test
    public void should_decrease_item_quality(){
    ...
    @Test
    public void should_decrease_twice_item_quality(){
    ...
    @Test
    public void should_decrease_to_zero_item_quality(){
    ...
    @Test
    public void should_decrease_sulfuras_item_quality(){
